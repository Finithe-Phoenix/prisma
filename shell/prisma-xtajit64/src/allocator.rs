...
#[unsafe(naked)]
unsafe extern "C" fn preserving_alloc(_size: usize, _align: usize) -> *mut u8 {
    preserve_arm64ec_nonvolatiles!(system_alloc)
}

#[unsafe(naked)]
unsafe extern "C" fn preserving_dealloc(_pointer: *mut u8, _size: usize, _align: usize) {
    preserve_arm64ec_nonvolatiles!(system_dealloc)
}

#[unsafe(naked)]
unsafe extern "C" fn preserving_alloc_zeroed(_size: usize, _align: usize) -> *mut u8 {
