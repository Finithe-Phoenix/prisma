...
F3-WN-003 implements only the load and lifecycle handshake. Every callback
...
code. They record `STATUS_NOT_SUPPORTED`, making the boundary to F3-WN-004/005
