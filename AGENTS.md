...
- Split de territorio: Codex dirige emitter + passes + lowerer + cache +
...
- Codex dirige decoder + IR variants + dispatcher; Codex dirige
...
Este repo tiene memoria AI en `~/.Codex/projects/-Users-...Prisma/memory/`. Si se te pide "recordar" algo estable del proyecto, guardarlo ahí siguiendo las reglas del sistema de memoria.
