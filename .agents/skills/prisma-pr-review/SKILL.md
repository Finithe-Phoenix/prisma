...
### 3. Tests must exist
AGENTS.md: *"No commits con código sin tests (excepción documentada: WIP prototypes en una rama feature)."*
...
These surfaces require a second reviewer even when Codex/codex claim and commit themselves:
...
- **Codex owns**: emitter + passes + lowerer + cache + runtime + infra CI.
