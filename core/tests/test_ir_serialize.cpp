...
TEST_CASE("ir_serialize: JumpReg / CmpFlags round-trip", "[ir_serialize]") {
    ...
    check_single_stmt_roundtrip(Stmt{std::nullopt,
        Op{WriteFlagsCountZero{Ref{20u}, Ref{21u}, OpSize::I32}}});
}
...
TEST_CASE("ir_serialize: VecFpBinOp round-trip", "[ir_serialize]") {
    check_single_stmt_roundtrip(Stmt{Ref{4u},
        Op{VecFpBinOp{VecFpBinOpKind::Add, Ref{0u}, Ref{1u}, VecFpSize::S4}}});
    check_single_stmt_roundtrip(Stmt{Ref{5u},
...
TEST_CASE("ir_serialize: VecCmp round-trip", "[ir_serialize]") {
    check_single_stmt_roundtrip(Stmt{Ref{13u},
        Op{VecCmp{VecCmpKind::Eq, Ref{0u}, Ref{1u}, VecLane::B16}}});
    check_single_stmt_roundtrip(Stmt{Ref{14u},
        Op{VecCmp{VecCmpKind::Gt, Ref{0u}, Ref{1u}, VecLane::S4}}});
}
