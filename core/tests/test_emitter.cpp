...
TEST_CASE("Emitter: fadd / fsub / fmul / fdiv (f32) emit the right mnemonics") {
  ...
  em.fadd(backend::Emitter::FpReg::V2, backend::Emitter::FpReg::V0, backend::Emitter::FpReg::V1,
          ir::FpSize::F32);
  em.fsub(backend::Emitter::FpReg::V3, backend::Emitter::FpReg::V0, backend::Emitter::FpReg::V1,
          ir::FpSize::F32);
  em.fmul(backend::Emitter::FpReg::V4, backend::Emitter::FpReg::V0, backend::Emitter::FpReg::V1,
          ir::FpSize::F32);
  em.fdiv(backend::Emitter::FpReg::V5, backend::Emitter::FpReg::V0, backend::Emitter::FpReg::V1,
          ir::FpSize::F32);
  em.finalize();
  const std::string d = em.disassemble();
