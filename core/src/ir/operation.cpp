...
bool operator==(const StoreRflagsFromBits& a, const StoreRflagsFromBits& b) noexcept {
  return a.pf == b.pf && a.af == b.af && a.zf == b.zf && a.sf == b.sf && a.of == b.of;
}
...
bool operator==(const WideDiv& a, const WideDiv& b) noexcept {
  return a.high == b.high && a.low == b.low && a.divisor == b.divisor &&
         a.is_signed == b.is_signed && a.result == b.result;
}
...
bool operator==(const Select& a, const Select& b) noexcept {
  return a.cc == b.cc && a.true_value == b.true_value && a.false_value == b.false_value &&
         a.size == b.size;
}
...
bool operator==(const AtomicCmpxchg& a, const AtomicCmpxchg& b) noexcept {
  return a.addr == b.addr && a.expected == b.expected && a.new_value == b.new_value &&
         a.size == b.size;
}
bool operator==(const AtomicCmpxchgPair& a, const AtomicCmpxchgPair& b) noexcept {
  return a.addr == b.addr && a.expected_low == b.expected_low &&
         a.expected_high == b.expected_high && a.new_low == b.new_low && a.new_high == b.new_high &&
...
bool operator==(const CallRel& a, const CallRel& b) noexcept {
  return a.target_guest_pc == b.target_guest_pc && a.return_guest_pc == b.return_guest_pc;
}
...
bool operator==(const CondJumpRel& a, const CondJumpRel& b) noexcept {
  return a.cc == b.cc && a.target_guest_pc == b.target_guest_pc &&
         a.fallthrough_guest_pc == b.fallthrough_guest_pc;
}
bool operator==(const Extend& a, const Extend& b) noexcept {
  return a.value == b.value && a.from_size == b.from_size && a.to_size == b.to_size &&
...
bool operator==(const CondJumpFlags& a, const CondJumpFlags& b) noexcept {
  return a.flags == b.flags && a.cc == b.cc && a.if_true == b.if_true && a.if_false == b.if_false;
}
...
bool operator==(const VecClMul& a, const VecClMul& b) noexcept {
  return a.lhs == b.lhs && a.rhs == b.rhs && a.lhs_high == b.lhs_high && a.rhs_high == b.rhs_high;
}
...
bool operator==(const VecFpFma& a, const VecFpFma& b) noexcept {
  return a.a == b.a && a.b == b.b && a.c == b.c && a.neg_addend == b.neg_addend &&
         a.neg_mul == b.neg_mul && a.size == b.size;
}
bool operator==(const VecFpScalarFma& a, const VecFpScalarFma& b) noexcept {
  return a.a == b.a && a.b == b.b && a.c == b.c && a.scalar_upper == b.scalar_upper &&
         a.neg_addend == b.neg_addend && a.neg_mul == b.neg_mul && a.size == b.size;
}
bool operator==(const RepStos& a, const RepStos& b) noexcept {
  return a.size == b.size && a.reverse == b.reverse && a.pc_of_rep == b.pc_of_rep &&
...
bool operator==(const PcmpStrIndex& a, const PcmpStrIndex& b) noexcept {
  return a.lhs == b.lhs && a.rhs == b.rhs && a.lhs_len == b.lhs_len && a.rhs_len == b.rhs_len &&
         a.imm8 == b.imm8;
}
...
bool operator==(const FpCvtScalar& a, const FpCvtScalar& b) noexcept {
  return a.lhs == b.lhs && a.src == b.src && a.src_size == b.src_size && a.dst_size == b.dst_size;
}
bool operator==(const VecShuffle2Src& a, const VecShuffle2Src& b) noexcept {
  return a.is_pd == b.is_pd && a.lhs == b.lhs && a.rhs == b.rhs && a.control == b.control;
}
bool operator==(const VecInsertLane& a, const VecInsertLane& b) noexcept {
  return a.lhs_xmm == b.lhs_xmm && a.value == b.value && a.lane_idx == b.lane_idx &&
         a.lane == b.lane;
}
...
bool operator==(const VecFpCompare& a, const VecFpCompare& b) noexcept {
  return a.lhs == b.lhs && a.rhs == b.rhs && a.size == b.size && a.pred == b.pred &&
...
bool operator==(const VecExtend& a, const VecExtend& b) noexcept {
  return a.src == b.src && a.narrow_lane == b.narrow_lane && a.wide_lane == b.wide_lane &&
         a.is_signed == b.is_signed;
}
bool operator==(const VecFpRound& a, const VecFpRound& b) noexcept {
  return a.lhs == b.lhs && a.src == b.src && a.size == b.size && a.mode == b.mode &&
         a.is_packed == b.is_packed;
}
...
bool operator==(const WriteFlagsCountZero& a, const WriteFlagsCountZero& b) noexcept {
  return a.src == b.src && a.result == b.result && a.size == b.size;
}
...
bool operator==(const WriteFlagsPtestYmm& a, const WriteFlagsPtestYmm& b) noexcept {
  return a.lo_lhs == b.lo_lhs && a.lo_rhs == b.lo_rhs && a.hi_lhs == b.hi_lhs &&
         a.hi_rhs == b.hi_rhs;
}
...
bool operator==(const VecSha& a, const VecSha& b) noexcept {
  return a.kind == b.kind && a.a == b.a && a.b == b.b && a.wk == b.wk && a.imm == b.imm;
}
...
bool operator==(const VecGather& a, const VecGather& b) noexcept {
  return a.base == b.base && a.index == b.index && a.mask == b.mask && a.prev == b.prev &&
         a.scale_shift == b.scale_shift && a.elem_is64 == b.elem_is64 &&
         a.index_is64 == b.index_is64 && a.lane_count == b.lane_count &&
         a.dest_lane_base == b.dest_lane_base && a.index_lane_base == b.index_lane_base;
}
