...
| 14i | Guest feature discovery: XGETBV + VZEROUPPER/ALL + CPUID 0/1/7 | 4 commits | `b61b865`, `bc0fe74`, `fbe0c5d`, `2b5a7b2` | ✅ done | FEAT_AES detection + AES e2e gate; Xgetbv IR op (tag 90) with baked XCR0=0x7; VZERO* synthesized from VecConstant+StoreVecReg(Hi); vendor GenuineIntel + leaf 1 honest bits (FPU/CMOV/SSE/SSE2 + SSE3/SSSE3/FMA/CX16/SSE4.1/MOVBE/OSXSAVE/AVX, AESNI host-gated) + leaf 7 BMI2. Self-review dropped TSC/CX8/POPCNT/SSE4.2 (decoder can't back them); Codex caught VEX scalar vvvv merge bug (CVTSS2SD/MOVSS/ROUNDSS) — fixed + pinned. Queued: 32-bit POPCNT/LZCNT/TZCNT/BSF/BSR forms, PCMPxSTRx, RDTSC via CNTVCT_EL0, CVTSI2* upper-lane merge, SSE3/SSSE3/SSE4.1 thin spots. |
