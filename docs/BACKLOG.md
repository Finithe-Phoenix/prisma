...
- [ ] F0-DC-027: Write `docs/ARCHITECTURE.md` — one-page tour of the monorepo.
...
- [~|claude] F1-DC-020: INC r/m64 (48 FF /0).
- [~|claude] F1-DC-021: DEC r/m64 (48 FF /1).
...
- [ ] F1-IR-016: IR validator pass — catch undef refs, mis-sized operands.
...
- [ ] F1-BK-005: Emitter label management (vixl Label class).
- [ ] F1-BK-006: Basic block → CFG lowering with label fix-up.
- [ ] F1-BK-007: Linear-scan register allocator over scratch pool.
...
- [ ] F1-RT-016: CPU feature detection: FEAT_LSE2, LRCPC2, FlagM.
- [ ] F1-RT-017: HostFeatures struct + runtime initialisation.
...
- [ ] F1-DC-004: RFC 0006 — register allocator design.
- [ ] F1-DC-005: RFC 0007 — cache file format.
